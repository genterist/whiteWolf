...
@implementation TasksDBDS

static NSString *const kUrl           = @"https://a99a97b8-cde8-4992-8986-dcac813b9f12-bluemix:0b8375b6901a6ab9472e021be49175f43bb6bf2005ede936108a29084d6e38da@a99a97b8-cde8-4992-8986-dcac813b9f12-bluemix.cloudant.com/tasks";
static NSString *const kDatastoreName = @"tasks";

- (instancetype)init {

    self = [super initWithUrlString:kUrl 
                      datastoreName:kDatastoreName
                       objectsClass:[TasksDBDSSchemaItem class]];
    if (self) {
