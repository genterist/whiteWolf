...
@interface NurseStation1ViewController ()
...
@implementation NurseStation1ViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"NurseStation1"];
