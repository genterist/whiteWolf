				...
				if(!data.hasOwnProperty("added"))
				{
					...
					document.getElementById("empty_database").style.display="none";
          			...
          			for(var i = 0; i < data.length; i++){
                        ...
                        names_table += "            <div id=\""+i+"_task1\">Task 1 : "+data[i].task1+"</div>";
                        names_table += "            <div id=\""+i+"_task2\">Task 2 : "+data[i].task2+"</div>";
                        names_table += "            <div id=\""+i+"_task3\">Task 3 : "+data[i].task3+"</div>";
                        names_table += "            <div id=\""+i+"_task4\">Task 4 : "+data[i].task4+"</div>";
                        names_table += "            <div id=\""+i+"_task5\">Task 5 : "+data[i].task5+"</div>";
                        names_table += "            <div id=\""+i+"_task6\">Task 6 : "+data[i].task6+"</div>";
                        names_table += "            <div id=\""+i+"_task7\">Task 7 : "+data[i].task7+"</div>";
                        names_table += "            <div id=\""+i+"_task8\">Task 8 : "+data[i].task8+"</div>";
